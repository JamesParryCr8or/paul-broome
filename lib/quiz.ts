...
export const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'conservatories', label: 'Conservatories', icon: 'home' }, { value: 'kitchens-bathrooms', label: 'Kitchens & bathrooms', icon: 'kitchen' },
      { value: 'solar', label: 'Solar', icon: 'sun' }, { value: 'landscaping-driveways', label: 'Landscaping & driveways', icon: 'tree' },
      { value: 'builders-renovations', label: 'Builders & renovations', icon: 'hammer' }, { value: 'other', label: 'Other home improvement', icon: 'grid' },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      { value: 'under-10', label: 'Fewer than 10', icon: 'calendar' }, { value: '10-24', label: '10–24', icon: 'calendar' },
      { value: '25-49', label: '25–49', icon: 'calendar' }, { value: '50-99', label: '50–99', icon: 'calendar' },
      { value: '100-plus', label: '100+', icon: 'calendar' },
    ],
  },
  {
    ...
    options: [
      ...
      { value: '11-plus', label: '11+', icon: 'team' },
    ],
  },
  {
    ...
    options: [
      { value: '0-2', label: '0–2', note: '0–20% close rate', icon: 'gauge' }, { value: '3-4', label: '3–4', note: '30–40% close rate', icon: 'gauge' },
  ...
  },
  {
    ...
    options: [
      { value: 'ghosting', label: 'Homeowners ghosting after the quote', icon: 'ghost' }, { value: 'more-quotes', label: '“We’re getting more quotes”', icon: 'quotes' },
      { value: 'price-objections', label: 'Price objections', icon: 'tag' }, { value: 'discounting', label: 'Discounting to win the job', icon: 'discount' },
      { value: 'inconsistent-team', label: 'Inconsistent salespeople', icon: 'shuffle' }, { value: 'slow-decisions', label: 'Slow decisions and chasing', icon: 'clock' },
    ],
  },
  {
    ...
    options: [
      { value: 'under-5000', label: 'Under £5,000', icon: 'tag' }, { value: '5000-9999', label: '£5,000–£9,999', icon: 'tag' },
      { value: '10000-19999', label: '£10,000–£19,999', icon: 'tag' }, { value: '20000-49999', label: '£20,000–£49,999', icon: 'tag' },
      { value: '50000-plus', label: '£50,000+', icon: 'tag' },
    ],
  },
  {
    ...
    options: [
      { value: 'close-rate', label: 'A higher close rate', icon: 'target' }, { value: 'margin', label: 'Better margins and less discounting', icon: 'margin' },
      { value: 'consistency', label: 'A more consistent sales team', icon: 'team' }, { value: 'faster-decisions', label: 'Faster homeowner decisions', icon: 'clock' },
      { value: 'control', label: 'More control in every conversation', icon: 'compass' },
    ],
  },
  {
    ...
    options: [
      { value: 'now', label: 'Now — this is a priority', icon: 'rocket' }, { value: '30-days', label: 'Within the next 30 days', icon: 'calendar' },
      { value: '90-days', label: 'Within the next 90 days', icon: 'clock' }, { value: 'researching', label: 'I’m researching for later', icon: 'search' },
    ],
  },
] as const;
...
export const leadSchema = z.object({
  ...
  name: z.string().trim().min(2).max(100), company: z.string().trim().min(2).max(140),
